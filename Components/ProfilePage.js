    ...
    <View style={tw`flex-1 bg-gray-900`}>
      <ScrollView contentContainerStyle={tw`flex-grow`}>
        ...
        <View style={tw`relative`}>
          <Image
            source={{ uri: "https://via.placeholder.com/1500x500" }}
        ...
        <View style={tw`p-5`}>
          ...
          >
            <Text style={tw`text-white mb-1`}>
              10th Grade Marks: {userData.education10th?.marks}
            </Text>
            <Text style={tw`text-white mb-1`}>
              12th Grade Marks: {userData.education12th?.marks}
            </Text>
            <Text style={tw`text-white mb-1`}>
              College: {userData.collegeDetails?.collegeName}
            </Text>
            <Text style={tw`text-white mb-1`}>
              Branch: {userData.collegeDetails?.courseBranch}
            </Text>
            <Text style={tw`text-white mb-1`}>
              CGPA: {userData.collegeDetails?.cgpa}
            </Text>
          </ProfileSection>

          {/* Skills Section */}
          <ProfileSection
            icon={<Entypo name="tools" size={24} color="white" />}
            title="Skills"
          >
            <Text style={tw`text-white mb-1`}>
          ...
          {/* Interests Section */}
          <ProfileSection
            icon={<MaterialIcons name="interests" size={24} color="white" />}
            title="Interests"
          >
            <Text style={tw`text-white mb-1`}>
