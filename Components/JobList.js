  ...
  const jobs = [
    {
      ...
      time: "5min",
      logo: { uri: "https://cdn.vox-cdn.com/thumbor/qwYo7XAE3Loy8QPMmJjRKrCLWAY=/0x0:2040x1360/1200x628/filters:focal(1020x680:1021x681)/cdn.vox-cdn.com/uploads/chorus_asset/file/23935561/acastro_STK103__04.jpg" },
      requirements: [
    ...
    },
    {
      ...
      time: "1hr",
      logo: { uri: "https://bsmedia.business-standard.com/_media/bs/img/article/2023-06/06/full/1686046036-9475.jpeg" },
      requirements: [
        "Proficiency in JavaScript, TypeScript, and at least one backend language (e.g., Java, Python, Node.js).",
        "Experience with React, Angular, or Vue.js.",
      ],
    ...
    },
    {
      ...
      time: "5min",
      logo: { uri: "https://cdn.vox-cdn.com/thumbor/DZh9VoCJ3ci4j3nCI-HmwWVLByk=/0x0:2040x1360/1400x1050/filters:focal(1020x680:1021x681)/cdn.vox-cdn.com/uploads/chorus_asset/file/24016885/STK093_Google_04.jpg" },
      requirements: [
        "Proficiency in JavaScript, TypeScript, and at least one backend language (e.g., Java, Python, Node.js).",
        "Experience with React, Angular, or Vue.js.",
      ],
    ...
    },
    {
      ...
      time: "Upcoming",
      logo: { uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8VRmuwZhG40QDxM_IF9klXkzNA96GmX1z2Q&s" },
      requirements: [
    ...
    },
    {
      ...
      time: "Ongoing",
      logo: { uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsMxxGsCr27cJafqIAAkzYPfZDKPDwfK7XpA&s" },
      requirements: [
    ...
    },
    {
      ...
      thumbnail: { uri: "https://miro.medium.com/v2/resize:fit:1400/0*cl7fc6pt1MHjIF4K.png" },
    ...
    },
    {
      ...
      channel: "Tech Talks",
      thumbnail: { uri: "https://ehuwt7zd2je.exactdn.com/wp-content/uploads/2024/03/future-o-javascript.jpg" },
    ...
    },
    {
      ...
      channel: "Dev Journey",
      thumbnail: { uri: "https://readybytes.in/media/pages/blog/how-to-setup-react-native-localization-for-react-native-app/4081d4f11e-1680348760/1-cover.jpg" },
